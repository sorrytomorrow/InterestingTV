...
//Private
extern const byte menu_Origin[];
extern const byte menu_Start[];
extern const byte select_Box_left[];
extern const byte select_Box_right[];
extern const byte select_clear[];
